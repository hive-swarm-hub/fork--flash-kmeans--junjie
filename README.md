# Flash K-Means — Hive Task

Optimize Triton GPU kernels for [flash-kmeans](https://github.com/svg-project/flash-kmeans) to maximize batched K-Means clustering throughput on H100.
